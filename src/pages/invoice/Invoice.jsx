          ...
          <div className="bottomContent">
              ...
              <div className="info">
                ...
                <div className="bottomInfo">
                  ...
                  <div className="left">
                    ...
                    <div className="item">
                      <span className="key">Address:</span>
                      <span className="value"> {invoice.address} </span>
                    </div>{' '}
                    {/* <div className="item">
                    ...
                    <div className="item">
                      <span className="key">NIF:</span>
                      <span className="value"> {invoice.nif} </span>
                    </div>{' '}
                    <div className="item">
                      <span className="key">R.C:</span>
                      <span className="value"> {invoice.rc} </span>
                    </div>{' '}
                    <div className="item">
                      <span className="key">Activité:</span>
                      <span className="value"> {invoice.activity} </span>
                    </div>
                    <div className="item">
                      <span className="key">Numéro d'article:</span>
                      <span className="value"> {invoice.na} </span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="b">
              <div className="leftRight">
                <p className="totalString"> {invoice.totalString} </p>
                  ...
                  <div className="calcRight">
                    <div className="calcItem">
                      <div className="calcItem">
                        ...
                        <span className="value">{invoice.total},00 DA</span>
                      </div>
                    ...
                    <div className="calcItem">
                      ...
                      <span className="value">
                        {invoice.total + invoice.total * 0.19},00 DA
                      </span>
                    </div>
                  </div>
                </div>
